  ...
  return {
    form: {
      ...
      component: (dynamic as any)({
        ...
        component: () =>
          import('./pages/FormPage/FormPage').then(e => Object.values(e)[0])
      })
    },
    table: {
      path: '/table',
      component: (dynamic as any)({
        app,
        component: () =>
          import('./pages/TablePage/TablePage').then(e => Object.values(e)[0])
      })
    },
    urlState: {
      path: '/url-state',
      component: (dynamic as any)({
        app,
        component: () =>
          import('./pages/UrlStateExample/UrlStateExample').then(
            e => Object.values(e)[0]
          )
      })
    }
...
> {
  ...
  render() {
    ...
    if (keyFirst) {
      routeAllow.unshift(
        <Route exact key="/" path="/" component={config[keyFirst].component} />
      );
